...
class TestGitHubClient:
    ...
    @patch("test_ai.api_clients.github_client.get_settings")
    @patch("test_ai.api_clients.github_client.Github")
    def test_init_with_token(self, mock_github, mock_settings):
        ...
        from test_ai.api_clients.github_client import GitHubClient
    ...
    def test_commit_file_updates_existing(self, mock_github, mock_settings):
        ...
        result = client.commit_file(
            "owner/repo", "file.txt", "new content", "Update file"
        )
...
class TestGmailClient:
    ...
    @patch("test_ai.api_clients.gmail_client.get_settings")
    def test_init_with_credentials(self, mock_settings):
        ...
        from test_ai.api_clients.gmail_client import GmailClient
...
class TestClaudeCodeClient:
    ...
    @patch("test_ai.api_clients.claude_code_client.get_settings")
    def test_init_api_mode(self, mock_settings):
        ...
        with patch(
            "test_ai.api_clients.claude_code_client.anthropic"
        ) as mock_anthropic:
    ...
    @patch("test_ai.api_clients.claude_code_client.get_settings")
    @patch("test_ai.api_clients.claude_code_client.subprocess.run")
    ...
    def test_execute_agent_api_success(self, mock_settings):
        ...
        with patch(
            ...
            result = client.execute_agent(
                "planner", "Build a feature", context="Some context"
            )
    ...
    def test_generate_completion_api(self, mock_settings):
        ...
        with patch(
            ...
            result = client.generate_completion(
                "Explain this", system_prompt="Be helpful"
            )
    ...
    def test_execute_cli_command(self, mock_run, mock_settings):
        ...
        client = ClaudeCodeClient()
        result = client.execute_cli_command(
            "Do something", working_dir="/tmp", timeout=60
        )
