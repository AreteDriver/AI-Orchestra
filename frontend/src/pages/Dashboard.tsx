...
import { useDashboardStats, useBudgetSummary, useExecutions } from '@/hooks/useApi';
            ...
            <div className="space-y-6">
              ...
              <div>
                <div className="mb-2 flex items-center justify-between text-sm">
                  ...
                  <span className="font-medium">$42.50 / $100.00</span>
                </div>
              ...
              <div className="space-y-3">
                ...
                {[
                  { agent: 'Builder', used: 18.50, limit: 40 },
                  { agent: 'Planner', used: 8.20, limit: 20 },
                  { agent: 'Reviewer', used: 12.30, limit: 25 },
                  { agent: 'Tester', used: 3.50, limit: 15 },
                ].map((item) => (
              ...
              <div className="rounded-lg bg-yellow-500/10 p-3">
                <div className="flex items-center gap-2 text-sm text-yellow-600">
                  ...
                  <span>Builder agent at 46% of monthly limit</span>
                </div>
              </div>
            </div>
          </CardContent>
